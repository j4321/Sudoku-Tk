...
class Aide(Toplevel):
    ...
    def __init__(self, master, **options):
        ...
        txt.insert("end", _("The levels given are only indicative, there might be significative variations in the difficulty of puzzles of the same level. The criteria used to define the levels are the following:") + '\n')
        txt.insert("end", "\t• ")
        txt.insert("end", _("Easy"), ("it"))
        txt.insert("end", ": ")
        txt.insert("end", _("The puzzle is solvable using only simple elimination rules.") + '\n')
        txt.insert("end", "\t• ")
        txt.insert("end", _("Medium"), ("it"))
        txt.insert("end", ": ")
        txt.insert("end", _("The puzzle is solvable using more complexe elimination rules.") + '\n')
        txt.insert("end", "\t• ")
        txt.insert("end", _("Difficult"), ("it"))
        txt.insert("end", ": ")
        txt.insert("end", _("This software had to use a backtracking method to solve the puzzle.") + '\n\n')
