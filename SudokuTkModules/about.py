...
from SudokuTkModules.constantes import set_icon, lang, STYLE, ICONE_48, VERSION
...
class About(Toplevel):
    ...
    def __init__(self, parent, **options):
        ...
        self.image = ImageTk.PhotoImage(Image.open(ICONE_48))
        ...
        Button(self, text=_("Close"), command=self._quitter).grid(row=5, column=1, pady=20, padx=4)
